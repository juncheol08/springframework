...
<div id="app">
    <div class="container">
        ...
        <div class="row">
            ...
            <form class="col s12 l6 offset-l3" action="fileUpload4" method="post" enctype="multipart/form-data">
                ...
                <div class="row center-align">
                    <div class="col s12 l8 offset-l2">
                        <div class="col s6">
                            <button type="button" class="btn-large waves-effect waves-light" id="btnAddFile">
